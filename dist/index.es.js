...
var encodeTypedDataHash = function (typedData) {
  return TypedData.encode(typedData)
}
...
var Proof = /** @class */ (function () {
  function Proof(args) {
    ...
    this.claims = (args === null || args === void 0 ? void 0 : args.claims)
      ? args.claims
      : { app: '', iat: 0, exp: 0, v: ETHAuthVersion }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          data = AbiFunction.encodeData(abiFunction, [messageDigest, proof.signature])
          return [
            4 /*yield*/,
            provider.request({
              method: 'eth_call',
...
var ETHAuth = /** @class */ (function () {
  function ETHAuth() {
    ...
    this.decodeProof = function (proofString_1) {
      ...
      return __awaiter(
        _this,
        __spreadArray([proofString_1], args_1, true),
        void 0,
        function (proofString, skipSignatureValidation) {
